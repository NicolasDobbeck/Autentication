...
const novaBebidaPromocao= async function (bebidaPromocao) {
    ...
    if ( bebidaPromocao.preco_promocao == '' || bebidaPromocao.preco_promocao == undefined ||bebidaPromocao.id_bebida == '' || bebidaPromocao.id_bebida == undefined){
        ...
        const novaBebidaPromocao = require('../model/model_bebida_promocao.js');
...
const atualizarBebidaPromocao = async function (bebidaPromocao) {
    ...
    else
    {
        ...
        const atualizarBebidaPromocao = require('../model/model_bebida_promocao.js');
...
const excluirBebidaPromocao  = async function (id) {
    ...
    if (id == ''|| id == undefined)
        ...
        {
            //import da model de sabor bebida
            const excluirBebidaPromocao = require('../model/model_bebida_promocao.js');
...
const listarBebidasPromocao = async function () {
    ...
    const { selectAllBebidasPromocoes} = require ('../model/model_bebida_promocao.js');

    const dadosBebidaPromocao= await selectAllBebidasPromocoes();
...
const buscarBebidaPromocao = async function (id) {
    ...
    if (id == ''|| id == undefined)
        ...
        const { selectByIdBebidaPromocao} = require ('../model/model_bebida_promocao.js');
